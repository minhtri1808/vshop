...
/*----------------------------------------*/
	...
	let $btns = $(".col-lg-12 .li-section-title ul li button");
	// gọi tới cái button
  
	$btns.click(function (e) {
	  $(".col-lg-12 .li-section-title ul li button").removeClass("active");
	  e.target.classList.add("active");
  
	  let selector = $(e.target).attr("data-filter");
	  // lấy data từ data-filter
	  $(".product_item").isotope({
		// filter theo ten class
		//demo : https://isotope.metafizzy.co/
		filter: selector,
	  });
	  return false;
	});
  
	$(".col-lg-12 .li-section-title ul li #btn1").trigger("click");
